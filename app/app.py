...
from src.components.graphs.dino_explainability import explain_dino
...
with per_image_tab:
    back_button, dino_button, next_button = st.columns(3)
    ...
    with dino_button:
        if st.button("Explain dino"):
            explain_dino(current_image_index)
